...
export default function Invoice({
  ...
  return (
    <div className="app-shadow mb-5 mt-3 w-[65%] rounded-md bg-white p-7 max-[1550px]:text-sm">
      {/* Header */}
      <div className="flex items-start justify-between">
        {/* Logo */}
        <Image src="/icons/Logo2.png" alt="Autoworx" width={100} height={100} />
        ...
        <div>
          ...
          {setting &&
            ...
            setting.contact
              .split("||")
              .map((info: string, index: number) => <p key={index}>{info}</p>)}
        </div>
      </div>
