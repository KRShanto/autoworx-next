...
export default function Page() {
  return (
    <div  className="relative flex flex-col items-center space-y-2 p-2 m-2 overflow-hidden">
      {/* Subscription Section */}
      <div className="mt-10 w-[762px] mb-2 ">
        ...
        <div className="flex gap-4 rounded-[5px] border border-[#D9D9D9] bg-white p-6 ">
          <div className="w-[50%] h-[212px]">
            <p className="font-inter mb-2 text-[20px] font-semibold leading-[24px] text-[#66738C]">
              Subscribed to{" "}
              <span className="font-semibold italic">Autoworx Basic Plan</span>
            </p>
            ...
            <div className="flex space-x-4 mt-8">
              <button className="font-inter h-[45px] w-[123px] rounded-[5px] bg-[#66738C] text-[20px] font-normal leading-[24px] text-white">
                Re-new
              </button>
              <button className="font-inter h-[45px] w-[136px] rounded-[5px] bg-[#6571FF] text-[20px] font-bold leading-[24px] text-white">
                Upgrade
              </button>
          ...
          {/* icon section */}
          <div>
            <Image src="/icons/LogoMain.svg" width={200} height={200} alt="Company logo"></Image>
          </div>
        </div>
      </div>

      {/* Payment Methods Section */}
      <div className="w-[762px] mb-4">
      ...
      <div className="w-[762px] mt-4">
        <h2 className="font-inter mb-4 text-[20px] font-semibold leading-[24px] text-[#66738C]">
          Payment History
        </h2>
        <div className="overflow-x-auto rounded-[5px] border border-[#D9D9D9] bg-white p-4 h-[180px]">
          <table className="min-w-full text-left">
            <thead>
              <tr className=" sticky -top-4 font-inter bg-white text-[16px] font-bold leading-[19px] text-[#66738C]">
