/*
  ...
  - You are about to drop the column `order_id` on the `appointment` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `appointment` DROP FOREIGN KEY `Appointment_order_id_fkey`;
...
-- AlterTable
ALTER TABLE `appointment` DROP COLUMN `order_id`,
    ADD COLUMN `draft_estimate` VARCHAR(191) NULL;
